...
class AdmnViewBusCanclFaqs extends StatelessWidget {
  final List<Map<String, dynamic>> faqs;

  const AdmnViewBusCanclFaqs({super.key, required this.faqs});
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final images = faq['images'] != null && faq['images'] is List
              ? faq['images']
              : [];
          final videoLink =
              faq.containsKey('video_link') && faq['video_link'] != null
                  ? faq['video_link']
                  : null;
