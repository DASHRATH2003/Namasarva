...
class CustomerViewRefundGuaranteeFaqs extends StatefulWidget {
  ...
  const CustomerViewRefundGuaranteeFaqs({Key? key, required this.faqId}) : super(key: key);
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(child: Text('Error loading FAQ details'));
          }
          if (!snapshot.hasData || !snapshot.data!.exists) {
            return Center(child: Text('No FAQ details found'));
          }
                ...
                if (_feedbackGiven) ...[
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16), // Spacing before buttons
