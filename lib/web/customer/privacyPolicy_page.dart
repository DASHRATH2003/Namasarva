            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSubPoint(
                      "Namma Savaari India Private Limited (hereinafter “Namma Savaari”) recognizes the importance of privacy of its users and also of maintaining confidentiality of the information provided by its users as a responsible data controller and data processor."),
                  _buildSubPoint(
                      "This Privacy Policy provides for the practices for handling and securing user's Personal Information (defined hereunder) by Namma Savaari and its subsidiaries and affiliates."),
                  _buildSubPoint(
                  ...
                  _buildSubPoint(
                      "For the purpose of this Privacy Policy, wherever the context so requires 'you' or 'your' shall mean User and the term 'we', 'us', 'our' shall mean Namma Savaari. For the purpose of this Privacy Policy, Website means the website(s), mobile site(s) and mobile app(s)."),
                  _buildSubPoint(
                  ...
                  _buildSubPoint(
                      "This Privacy Policy is an integral part of your User Agreement with Namma Savaari and all capitalized terms used, but not otherwise defined herein, shall have the respective meanings as ascribed to them in the User Agreement."),
                  ...
                  _buildSubSubSectionPoint(
                      "5. Information pertaining any other traveler(s) for who you make a booking through your registered Namma Savaari account. In such case, you must confirm and represent that each of the other traveler(s) for whom a booking has been made, has agreed to have the information shared by you disclosed to us and further be shared by us with the concerned service provider(s)."),
                  ...
                  _buildSubPoint(
                      "Namma Savaari uses cookies to personalize your experience on the Website and the advertisements that maybe displayed. Namma Savaari’s use of cookies is similar to that of any other reputable online companies."),
                  _buildSubPoint(
                  ...
                  _buildSubPoint(
                      "If the assets of Namma Savaari are acquired, our customer information may also be transferred to the acquirer depending upon the nature of such acquisition. In addition, as part of business expansion/development/restructuring or for any other reason whatsoever, if we decide to sell/transfer/assign our business, any part thereof, any of our subsidiaries or any business units, then as part of such restructuring exercise customer information including the Personal Information collected herein shall be transferred accordingly."),
                  ...
                  _buildSubPoint(
                      "Namma Savaari may share your Personal Information to third party that Namma Savaari may engage to perform certain tasks on its behalf, including but not limited to payment processing, data hosting, and data processing platforms."),
                  _buildSubPoint(
                  ...
                  _buildSubPoint(
                      "Occasionally, Namma Savaari will hire a third party for market research, surveys etc. and will provide information to these third parties specifically for use in connection with these projects. The information (including aggregate cookie and tracking information) we provide to such third parties, alliance partners, or vendors are protected by confidentiality agreements and such information is to be used solely for completing the specific project, and in compliance with the applicable regulations."),

                  _buildSectionTitle("4. DISCLOSURE OF INFORMATION"),
                  _buildSubPoint(
                      "In addition to the circumstances described above, Namma Savaari may disclose User's Personal Information if required to do so:"),
                  _buildSubSubSectionPoint(
                  ...
                  _buildSubPoint(
                      "You will occasionally receive e-mail updates from us about fare sales in your area, special offers, new Namma Savaari services, and other noteworthy items. We hope you will find these updates interesting and informative. If you wish not to receive them, please click on the 'unsubscribe' link or follow the instructions in each e-mail message."),

                  _buildSectionTitle(
                      "1. PERMISSIONS REQUIRED FOR USING OUR MOBILE APPLICATIONS"),
                  _buildSubPoint(
                      "When the Namma Savaari app is installed on your phone or tablet, a list of permissions appear and are needed for the app to function effectively. There is no option to customize the list. The permissions that Namma Savaari requires and the data that shall be accessed and its use is as below:"),
                  ...
                  _buildSubPoint(
                      "You may access your Personal Information from your user account with Namma Savaari. You may also correct your personal information or delete such information (except some mandatory fields) from your user account directly. If you don’t have such a user account, then you write to privacy@nammasavaari.com"),
                  ...
                  _buildSubPoint(
                      "You must atleast 18 years of age to transact directly with Namma Savaari and also to consent to the processing of your personal data."),
                  _buildSectionTitle(
                      "You may always submit concerns regarding this Privacy Policy via email to us at privacy@nammasavaari.com. Namma Savaari shall endeavor to respond to all reasonable concerns and inquiries."),
