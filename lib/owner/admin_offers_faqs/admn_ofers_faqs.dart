...
import 'admn_view_ofers_faqs.dart';



class AdmnOfersFaqs extends StatefulWidget {
  const AdmnOfersFaqs({super.key});

  @override
  State<AdmnOfersFaqs> createState() => _AdmnOfersFaqsState();
}

class _AdmnOfersFaqsState extends State<AdmnOfersFaqs> {
  ...
  Future<void> _saveFaq() async {
    ...
    if (_uploadedImages.isNotEmpty) {
      for (File image in _uploadedImages) {
        ...
        FirebaseStorage.instance.ref().child('offers_faqs_images/$fileName');
  ...
  void _viewFAQs() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => AdmnViewOfersFaqs(faqs: faqs),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Offers FAQs',style: TextStyle(color: Colors.white),),
      ),
      body: Padding(
