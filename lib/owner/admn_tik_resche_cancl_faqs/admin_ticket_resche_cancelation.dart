...
import 'admn_view_tik_resche_cancl_faqs.dart';

class AdmTikRescheCanclFaqs extends StatefulWidget {
  const AdmTikRescheCanclFaqs({super.key});

  @override
  State<AdmTikRescheCanclFaqs> createState() => _AdmTikRescheCanclFaqsState();
}

class _AdmTikRescheCanclFaqsState extends State<AdmTikRescheCanclFaqs> {
  ...
  Future<void> _saveFaq() async {
    ...
    if (_uploadedImages.isNotEmpty) {
      for (File image in _uploadedImages) {
        ...
        FirebaseStorage.instance.ref().child('ticket_resche_cancl_faqs_images/$fileName');
  ...
  void _viewFAQs() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => AdmnViewTikRescheCanclFaqs(faqs: faqs),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Ticket Reschedule / cancel FAQs',style: TextStyle(color: Colors.white),),
      ),
      body: Padding(
