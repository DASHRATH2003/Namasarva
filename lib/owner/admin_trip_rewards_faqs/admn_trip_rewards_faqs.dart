...
import 'admn_view_trip_rewards_faqs.dart';


class AdminTripRewardsFaqs extends StatefulWidget {
  const AdminTripRewardsFaqs({super.key});

  @override
  State<AdminTripRewardsFaqs> createState() => _AdminTripRewardsFaqsState();
}

class _AdminTripRewardsFaqsState extends State<AdminTripRewardsFaqs> {
  ...
  Future<void> _saveFaq() async {
    ...
    if (_uploadedImages.isNotEmpty) {
      for (File image in _uploadedImages) {
        ...
        FirebaseStorage.instance.ref().child('trip_rewards_faqs_images/$fileName');
  ...
  void _viewFAQs() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => AdminViewTripRewardsFaqs(faqs: faqs),
      ),
    );
  }
