...
class AdminPaymentAndRefundFaqs extends StatefulWidget {
  const AdminPaymentAndRefundFaqs({super.key});

  @override
  State<AdminPaymentAndRefundFaqs> createState() => _AdminPaymentAndRefundFaqsState();
}

class _AdminPaymentAndRefundFaqsState extends State<AdminPaymentAndRefundFaqs> {
  ...
  Future<void> _saveFaq() async {
    ...
    if (_uploadedImages.isNotEmpty) {
      for (File image in _uploadedImages) {
        ...
        FirebaseStorage.instance.ref().child('payment_and_refund_faqs_images/$fileName');
  ...
  void _viewFAQs() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => AdmnViewPaymentAndRefundFaqs(faqs: faqs),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Payment And Refund FAQs',style: TextStyle(color: Colors.white),),
      ),
      body: Padding(
