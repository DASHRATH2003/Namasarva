...
import 'admn_view_bus_cancl_faqs.dart';


class AdmnBusCanclFaqs extends StatefulWidget {
  const AdmnBusCanclFaqs({super.key});

  @override
  State<AdmnBusCanclFaqs> createState() => _AdmnBusCanclFaqsState();
}

class _AdmnBusCanclFaqsState extends State<AdmnBusCanclFaqs> {
  ...
  Future<void> _saveFaq() async {
    ...
    if (_uploadedImages.isNotEmpty) {
      for (File image in _uploadedImages) {
        ...
        FirebaseStorage.instance.ref().child('bus_cancl_faqs_images/$fileName');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Bus Cancelation FAQs',style: TextStyle(color: Colors.white),),
      ),
      body: Padding(
