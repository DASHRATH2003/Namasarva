...
import 'admn_view_other_quesries_faqs.dart';

class AdminOtherQueriesFaqs extends StatefulWidget {
  const AdminOtherQueriesFaqs({super.key});

  @override
  State<AdminOtherQueriesFaqs> createState() => _AdminOtherQueriesFaqsState();
}

class _AdminOtherQueriesFaqsState extends State<AdminOtherQueriesFaqs> {
  ...
  Future<void> _saveFaq() async {
    ...
    if (_uploadedImages.isNotEmpty) {
      for (File image in _uploadedImages) {
        ...
        FirebaseStorage.instance.ref().child('other_queries_faqs_images/$fileName');
  ...
  void _viewFAQs() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => AdminViewOtherQueriesFaqs(faqs: faqs),
      ),
    );
  }
