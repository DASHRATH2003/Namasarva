...
class TicketBookingsScreen extends StatefulWidget {
  const TicketBookingsScreen({super.key});

  @override
  State<TicketBookingsScreen> createState() => _TicketBookingsScreenState();
}

class _TicketBookingsScreenState extends State<TicketBookingsScreen> {
  ...
  Future<void> _saveFaq() async {
    ...
    if (_uploadedImages.isNotEmpty) {
      for (File image in _uploadedImages) {
        ...
        FirebaseStorage.instance.ref().child('ticket_booking_faqs_images/$fileName');
  ...
  void _viewFAQs() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ViewFAQPage(faqs: faqs),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Ticket Bookings FAQs',style: TextStyle(color: Colors.white),),
      ),
      body: Padding(
