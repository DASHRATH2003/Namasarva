...
//
// class AdminOffersPredefinedMessagesScreen extends StatefulWidget {
//   @override
//   State<AdminOffersPredefinedMessagesScreen> createState() => _AdminOffersPredefinedMessagesScreenState();
// }
//
// class _AdminOffersPredefinedMessagesScreenState extends State<AdminOffersPredefinedMessagesScreen> {
...
//     final doc = await FirebaseFirestore.instance.collection('admin').doc('admin_offers_prefred_messages').get();
//
//     if (doc.exists) {
//       final data = doc.data();
//       if (data != null) {
...
//     } else {
//       // Add a new message
//       await FirebaseFirestore.instance.collection('admin').doc('admin_offers_prefred_messages').set({
...
//       appBar: AppBar(title: Text('admin offers Predefined Messages')),
//       body: Padding(
...
class AdminOffersPredefinedMessagesScreen extends StatefulWidget {
  const AdminOffersPredefinedMessagesScreen({super.key});

  @override
  State<AdminOffersPredefinedMessagesScreen> createState() =>
      _AdminOffersPredefinedMessagesScreenState();
}

class _AdminOffersPredefinedMessagesScreenState
    extends State<AdminOffersPredefinedMessagesScreen> {
  final TextEditingController _questionController = TextEditingController();
  final TextEditingController _answerController = TextEditingController();
  final TextEditingController _searchController = TextEditingController();
  ...
  Future<void> _saveMessage() async {
    ...
    try {
      if (_editingIndex != null) {
        ...
        _showSuccessSnackbar('Offer message saved successfully!');
      }
    ...
    try {
      ...
      if (doc.exists) {
        ...
        if (data != null) {
          ...
          _showSuccessSnackbar('Offer message updated successfully!');
        }
      }
    } catch (e) {
  ...
  Future<void> _deleteMessage(int index) async {
    bool confirmDelete = await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Are you sure you want to delete this offer message?'),
        actions: [
          TextButton(
    ...
    try {
      ...
      if (doc.exists) {
        ...
        if (data != null) {
          ...
          _showSuccessSnackbar('Offer message deleted successfully!');
          await _fetchMessages();
        }
      }
    } catch (e) {
          ...
          children: [
            ...
            Container(
              ...
              child: TextField(
                controller: _searchController,
                decoration: InputDecoration(
                  hintText: 'Search offer messages...',
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      _editingIndex != null
                          ? '✏️ Edit Offer Message'
                          : '➕ Add New Offer Message',
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
            ...
            Row(
              children: [
                ...
                Chip(
                  label: Text('${_filteredMessages.length} offers'),
